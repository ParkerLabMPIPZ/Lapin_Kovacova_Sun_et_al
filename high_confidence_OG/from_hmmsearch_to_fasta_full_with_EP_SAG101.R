library(Biostrings)
INPUT_FASTA_FILE<-"SAG101_sign_BLAST.fa"
RESULT_FILE_FROM_HMM<-"./HMMoutput/per_domain_hits_EP_SAG101.txt"
OUTPUT_FILE<-"SAG101_sequences_with_EP.fa"
OUTPUT_ALL_MATCH_INFORMATION <- "./HMMoutput/SAG101_EP_characteristics_all_matches.txt"
OUTPUT_HISTOGRAM <- "length_distribution_SAG101_EP.pdf"
