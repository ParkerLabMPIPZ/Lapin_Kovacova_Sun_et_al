library(Biostrings)
INPUT_FASTA_FILE<-"PAD4_sign_BLAST.fa"
RESULT_FILE_FROM_HMM<-"./HMMoutput/per_domain_hits_EP_PAD4.txt"
OUTPUT_FILE<-"PAD4_sequences_with_EP.fa"
OUTPUT_ALL_MATCH_INFORMATION <- "./HMMoutput/PAD4_EP_characteristics_all_matches.txt"
OUTPUT_HISTOGRAM <- "length_distribution_PAD4_EP.pdf"
